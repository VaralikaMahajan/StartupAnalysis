...
```{r, echo=FALSE, warning=FALSE}
# 6.  Total raised vs. Total valuation---------------------------------------------------------------------
...
uni_new %>% 
  ...
  labs(title="6. Total Raised vs. Valuation (wrt Financial stage)",
       x="Total Amount raised ($B)")
...
```{r, echo=FALSE, warning=FALSE}
# 7. Does investor network (Location) play an important effect in determining valuation --------
...
uni_new %>% 
  ...
  labs(title="7. Unicorn location vs. number of investors & valuation. ",
       y="Average valuation ($B)",
       x="Number of investors",
       size="Unicorns count")+
  guides(color="none") +
  facet_grid(vars('Number of investors', 'Average valuation'))
```
...
# 8. Top 10 Categories with maximum Failed Startups ----------------------------------------------------------------------
...
ab %>% 
  ...
  geom_col()+
  geom_label(aes(label=count),hjust=0,vjust=1)+
  labs(title="8. Top 10 Categories with maximum Failed Startups",
...
```{r, echo=FALSE, warning=FALSE}
# 9. Where were these Failed Startups based out off? ----------------------------------------------------------------------
...
ggplot(counts, aes(x = "", y = n, fill = HeadquartersCity)) +
  ...
  labs(title = "9. Percentage of Dead Startups by Headquarters City",
...
# 10. Funding amount vs Status of Startups? ----------------------------------------------------------------------
...
ab %>% 
  ...
  labs(title="10. Amount Raised in Different Funding Rounds", x="Status of Startup",
...
```{r, echo=FALSE, warning=FALSE}
# 11. Plotting Categories wrt to Status for Startups
ggplot(ab, 
       aes(x = Categories, 
           fill = Satus)) + geom_bar(position = "stack")+theme(axis.title.x = element_text(size = rel(0.2)),
          axis.title.y = element_text(size = rel(0.2)))+labs(title="11.Plotting Categories wrt to Status for Startups")
```
